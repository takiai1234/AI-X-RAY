...
Một Agent huấn luyện được như vậy trong một phút. Bước tiếp theo đáng học là xây trợ lý sales của riêng bạn: tự ghi chú CRM, nhắc follow-up và luyện kịch bản mỗi ngày.`,
  ...
  hr: {
    id: "hr",
    label: "HR / Nhân sự",
    hook: "AI có thể gánh bao nhiêu % việc tuyển dụng và đào tạo của bạn?",
    taskLibrary: [
      ...
      { id: "phongvan", label: "Chuẩn bị câu hỏi phỏng vấn", aiSupportPct: 80, group: "quick_win" },
      { id: "onboarding", label: "Tài liệu onboarding", aiSupportPct: 80, group: "quick_win" },
      { id: "daotao", label: "Xây tài liệu đào tạo nội bộ", aiSupportPct: 75, group: "chuan_hoa_du_lieu" },
      { id: "chamcong", label: "Báo cáo nhân sự / chấm công", aiSupportPct: 70, group: "agent_automation" },
    ],
    goals: ["Tuyển nhanh và đúng người hơn", "Giảm việc giấy tờ", "Chuẩn hóa đào tạo", "Nâng vai trò HR trong công ty"],
    painPoints: [
      "JD viết mãi vẫn chưa hút ứng viên",
      "Lọc CV thủ công quá lâu",
      "Onboarding mỗi lần một kiểu",
      "Tài liệu đào tạo không ai cập nhật",
    ],
    scaleQuestion: {
...
Bộ tài liệu này AI tạo trong một phút. Bước tiếp theo đáng học là chuẩn hóa cả quy trình nhân sự bằng AI: từ tuyển dụng, onboarding đến đào tạo nội bộ tự cập nhật.`,
    ...
    roadmapPhases: [
      "JD và tin tuyển dụng bằng AI",
      "Scorecard và quy trình lọc CV",
      "Bộ phỏng vấn + onboarding chuẩn",
      "Tài liệu đào tạo nội bộ AI hóa",
      "Automation quy trình nhân sự",
    ],
  },
